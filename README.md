...
- พิมพ์คำสั่ง **"/model"** -> บอทจะแสดงเมนู Quick Reply ให้เลือกสลับโมเดล Gemini
- พิมพ์คำสั่ง **"/checkmodel"** -> บอทจะแสดงชื่อโมเดล Gemini ปัจจุบันที่คุณกำลังใช้งานอยู่
- พิมพ์คำว่า **"สวัสดี"** หรือ **"hello"** -> บอทจะกล่าวต้อนรับ
- พิมพ์คำว่า **"help"** -> บอทจะแสดงคำแนะนำ
- พิมพ์ข้อความอื่นๆ -> บอทจะใช้ **Gemini AI** เพื่อโต้ตอบกับคุณ (ค่าเริ่มต้นคือ `gemini-flash-latest`)
